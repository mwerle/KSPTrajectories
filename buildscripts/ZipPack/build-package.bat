...
cd "%rootPath%"
rem copy Trajectories dll from build directory to GameData
IF EXIST "%initialWD%\%TargetName%.dll" xcopy /y "%initialWD%\%TargetName%.dll" "GameData\%TargetName%\Plugin\*" > nul
